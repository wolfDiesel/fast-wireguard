...
def list(all: bool) -> None:
    ...
    if not all:
        ...
        filtered_clients = [client for client in clients if client["is_active"] and not client["is_blocked"]]
    ...
    for client in filtered_clients:
        ...
        table_data.append([client["name"], client["ip_address"], status_str, last_seen, created_at])
